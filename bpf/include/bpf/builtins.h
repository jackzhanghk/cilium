...
#define __it_set(a, b, op) (*(__u##op *)__it(a, op)) = b
	case 96:         __it_set(d, s, 64);
	case 88: jmp_88: __it_set(d, s, 64);
	case 80: jmp_80: __it_set(d, s, 64);
	case 72: jmp_72: __it_set(d, s, 64);
	case 64: jmp_64: __it_set(d, s, 64);
	case 56: jmp_56: __it_set(d, s, 64);
	case 48: jmp_48: __it_set(d, s, 64);
	case 40: jmp_40: __it_set(d, s, 64);
	case 32: jmp_32: __it_set(d, s, 64);
	case 24: jmp_24: __it_set(d, s, 64);
	case 16: jmp_16: __it_set(d, s, 64);
	case  8: jmp_8:  __it_set(d, s, 64);
		break;

	case 94: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_88;
	case 86: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_80;
	case 78: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_72;
	case 70: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_64;
	case 62: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_56;
	case 54: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_48;
	case 46: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_40;
	case 38: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_32;
	case 30: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_24;
	case 22: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_16;
	case 14: __it_set(d, s, 16); __it_set(d, s, 32); goto jmp_8;
	case  6: __it_set(d, s, 16); __it_set(d, s, 32);
		 break;

	case 92: __it_set(d, s, 32); goto jmp_88;
	case 84: __it_set(d, s, 32); goto jmp_80;
	case 76: __it_set(d, s, 32); goto jmp_72;
	case 68: __it_set(d, s, 32); goto jmp_64;
	case 60: __it_set(d, s, 32); goto jmp_56;
	case 52: __it_set(d, s, 32); goto jmp_48;
	case 44: __it_set(d, s, 32); goto jmp_40;
	case 36: __it_set(d, s, 32); goto jmp_32;
	case 28: __it_set(d, s, 32); goto jmp_24;
	case 20: __it_set(d, s, 32); goto jmp_16;
	case 12: __it_set(d, s, 32); goto jmp_8;
	case  4: __it_set(d, s, 32);
		 break;

	case 90: __it_set(d, s, 16); goto jmp_88;
	case 82: __it_set(d, s, 16); goto jmp_80;
	case 74: __it_set(d, s, 16); goto jmp_72;
	case 66: __it_set(d, s, 16); goto jmp_64;
	case 58: __it_set(d, s, 16); goto jmp_56;
	case 50: __it_set(d, s, 16); goto jmp_48;
	case 42: __it_set(d, s, 16); goto jmp_40;
	case 34: __it_set(d, s, 16); goto jmp_32;
	case 26: __it_set(d, s, 16); goto jmp_24;
	case 18: __it_set(d, s, 16); goto jmp_16;
	case 10: __it_set(d, s, 16); goto jmp_8;
	case  2: __it_set(d, s, 16);
		 break;

	case  1: __it_set(d, s, 8);
		break;
...
/* Unfortunately verifier forces aligned stack access while other
 * pointers do not have to be aligned (map, pkt, etc). Mark those
 * on the stack for objects > 8 bytes in order to force-align such
 * memcpy candidates when we really need them. Usually not needed
 * for <= 8 bytes and in case of > 8 bytes only when 8 byte is not
